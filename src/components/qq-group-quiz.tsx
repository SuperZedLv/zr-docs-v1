    ...
    questions: [
      {
        ...
        correct: 'b',
        errorMessage:
          'Please re-read the project introduction. BEST TOKEN is an open-source AI interface management and distribution system.',
      },
      {
        id: 'q2',
        question:
      ...
      {
        id: 'q3',
        question: '3. Does BEST TOKEN have a closed-source paid version?',
        options: [
          {
            value: 'true',
          ...
          },
          {
            value: 'false',
            label:
              'No, BEST TOKEN is open-source software, but a commercial license is required in certain scenarios',
          },
        ],
        correct: 'false',
        errorMessage:
          'According to Group Rule 4: BEST TOKEN is open-source software, but a commercial license is required in certain scenarios. For details, please see the Project Introduction.',
      },
      {
        id: 'q4',
        question:
    ...
    questions: [
      {
        ...
        correct: 'b',
        errorMessage:
          '请重新阅读项目介绍。BEST TOKEN 是一个开源的AI接口管理和分发系统。',
      },
      {
        id: 'q2',
      ...
      {
        id: 'q3',
        question: '3. BEST TOKEN 是否有闭源的付费版本？',
        options: [
          { value: 'true', label: '有，存在付费的闭源版本' },
          {
            value: 'false',
            label: '没有，BEST TOKEN 采用 AGPLv3 开源协议，遵守协议即可免费使用',
          },
        ],
        correct: 'false',
        errorMessage:
          '根据群规第4条：BEST TOKEN 采用 GNU AGPLv3 开源协议，只要遵守开源协议即可免费使用。',
      },
      {
        id: 'q4',
    ...
    questions: [
      {
        ...
        correct: 'b',
        errorMessage:
          'プロジェクト紹介を再度お読みください。BEST TOKENはオープンソースのAIインターフェース管理・配布システムです。',
      },
      {
        id: 'q2',
        question:
      ...
      {
        id: 'q3',
        question: '3. BEST TOKENにはクローズドソースの有料版がありますか？',
        options: [
          { value: 'true', label: 'はい、クローズドソースの有料版があります' },
          {
            value: 'false',
            label:
              'いいえ、BEST TOKENはオープンソースソフトウェアですが、特定のシナリオでは商用ライセンスが必要です',
          },
        ],
        correct: 'false',
        errorMessage:
          'グループルール4により：BEST TOKENはオープンソースソフトウェアですが、特定のシナリオでは商用ライセンスが必要です。詳細については、プロジェクト紹介をご覧ください。',
      },
      {
        id: 'q4',
        question:

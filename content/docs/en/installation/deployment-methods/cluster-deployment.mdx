...
This document provides detailed configuration steps and best practices for BestTokenRouter cluster deployment, helping you build a highly available, load-balanced distributed system.
...
The BestTokenRouter cluster adopts a master-slave architecture design:

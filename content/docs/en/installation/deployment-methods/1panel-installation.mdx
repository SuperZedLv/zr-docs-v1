...
This document provides a graphical tutorial for deploying BestTokenRouter using the 1Panel panel.
...
## Step 2: Install BestTokenRouter

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the BestTokenRouter application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure BestTokenRouter application parameters on the installation page:
</Callout>

- **Name**: The name of the BestTokenRouter application to be created
- **Version**: Select the version of BestTokenRouter
- **Port**: The service port for the BestTokenRouter application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the BestTokenRouter application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the BestTokenRouter application
...
## Step 4: Access BestTokenRouter

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the BestTokenRouter WebUI page
...
2. Find the BestTokenRouter application, click the **Upgrade** button

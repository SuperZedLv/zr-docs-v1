...
This document provides methods and best practices for updating the BestTokenRouter system to ensure a smooth upgrade to the latest version.
...
If you have deployed BestTokenRouter using a single Docker container, you can update by following these steps:
...
2.  Find the BestTokenRouter application and click the **Upgrade** button
...
2.  Find the BestTokenRouter container, click **More** -> **Recreate**
...
If you have deployed BestTokenRouter by compiling from source code, the update steps are as follows:

...
This document provides methods and best practices for updating the BEST TOKEN system to ensure a smooth upgrade to the latest version.
...
If you have deployed BEST TOKEN using a single Docker container, you can update by following these steps:
...
2.  Find the BEST TOKEN application and click the **Upgrade** button
...
2.  Find the BEST TOKEN container, click **More** -> **Recreate**
...
If you have deployed BEST TOKEN by compiling from source code, the update steps are as follows:

...
This document provides all environment variables supported by BEST TOKEN and their configuration instructions. You can customize the system's behavior by setting these environment variables.

<Callout type="info" title="Tip">
  BEST TOKEN supports reading environment variables from `.env` files. Please refer to the `.env.example`
...
| `FRONTEND_BASE_URL`               | Frontend base URL (used by slave nodes, redirects unmatched routes to this address) | -             | `FRONTEND_BASE_URL=https://<your-besttoken-domain>` |
...
# FRONTEND_BASE_URL=https://<your-besttoken-domain>

...
API Address: BEST TOKEN site address (e.g., `https://<your-newapi-domain>/v1`)
...
3.  **Add New Provider**
    - Click "Add Model"
    - Select BEST TOKEN
    ![Add BEST TOKEN Provider](/assets/aionui/newapi_provider.png)

4.  **Configure API Information**
    - API Address: Enter your BEST TOKEN site address (format: `https://<your-newapi-domain>/v1`)

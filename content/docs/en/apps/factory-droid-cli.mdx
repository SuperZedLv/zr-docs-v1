...
description: Factory Droid CLI setup guide — install and configure this AI software engineering agent with BestTokenRouter. Supports end-to-end development from planning to testing.
---

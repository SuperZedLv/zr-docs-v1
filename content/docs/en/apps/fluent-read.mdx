...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to BestTokenRouter for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the BestTokenRouter console, you can add
...
### Import Configuration from BestTokenRouter Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the BestTokenRouter console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the BestTokenRouter configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | BestTokenRouter                                  |
| Access Token        | BestTokenRouter Key                              |
| BestTokenRouter Endpoint     | BestTokenRouter Deployment Address (without /v1) |

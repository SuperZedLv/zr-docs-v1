...
Ratio settings are the core configuration of the BestTokenRouter billing system. By setting different Ratios, you can flexibly control the billing standards for various models and user groups.
...
BestTokenRouter employs a dual billing mechanism of pre-consumption and post-consumption:

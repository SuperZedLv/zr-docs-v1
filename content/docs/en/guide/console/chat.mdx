...
BestTokenRouter provides quick access to several AI chat applications, making them convenient for testing or use.
...
<Callout type="warn">
  ...
  BestTokenRouter; manual entry is required.
</Callout>
...
<Callout type="info">
  Supports one-click configuration import from BestTokenRouter
</Callout>

## AMA 问天

<Callout type="info">
  AMA 问天 is an intelligent Q&A assistant provided by BestTokenRouter, supporting

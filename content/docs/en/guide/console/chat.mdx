...
BEST TOKEN provides quick access to several AI chat applications, making them convenient for testing or use.
...
<Callout type="warn">
  ...
  BEST TOKEN; manual entry is required.
</Callout>
...
<Callout type="info">
  Supports one-click configuration import from BEST TOKEN
</Callout>

## AMA 问天

<Callout type="info">
  AMA 问天 is an intelligent Q&A assistant provided by BEST TOKEN, supporting

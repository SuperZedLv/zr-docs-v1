...
本文档提供了BestTokenRouter系统的更新方法和最佳实践，以确保您的系统平稳升级到最新版本。
...
如果您使用单个Docker容器部署了BestTokenRouter，可以按照以下步骤更新：
...
2. 找到BestTokenRouter容器，点击 **更多** -> **重新创建**
3. 勾选 **拉取最新镜像** 选项，确保其他配置保持不变
4. 点击 **提交** ，系统将自动拉取最新镜像并重新创建容器

## 从源码编译的更新方法

如果您是从源码编译部署的BestTokenRouter，更新步骤如下：

...
API 地址：BEST TOKEN 站点地址（例如：`https://<your-newapi-domain>/v1`）
...
3. **添加新的提供商**
   - 点击"添加模型"
   - 选择 BEST TOKEN
   ![添加 BEST TOKEN 提供商](/assets/aionui/newapi_provider.png)

4. **配置 API 信息**
   - API 地址：填写您的 BEST TOKEN 站点地址（格式：`https://<your-newapi-domain>/v1`）
